    ...
    return ( <>
            <main className={styles.Main}>    
                ...
                <header className={stylesSign.inUpHeader}>
                    ...
                    <h1 className={stylesSign.H1Elm} > Create a new Account </h1>
                    
                    <div className={stylesSign.NameInputs}>
                        <div className={stylesSign.Relativebox}>
                            <label className={stylesSign.Labels} for="FName" >
                             First Name
                            </label>
                            <img
                            src="/Sign/Names.png"
                            className={stylesSign.ImageInput}
                            />
                            <input
                                value={FName}
                                id="FName" type={"text"}
                                onChange={e=>setFName(e.target.value)}
                                className={stylesSign.InputDesign}
                        ...
                        <div className={stylesSign.Relativebox}>
                            <label className={stylesSign.Labels} for="SName" >
                             Last Name
                            </label>
                            <img src="/Sign/Names.png" alt="" className={stylesSign.ImageInput} />
                            <input
                                value={SName}
                                id="SName" type={"text"}
                        ...
                        <div className={stylesSign.Relativebox}>
                            ...
                            <img src="/Sign/mail.png" alt="" 
                                    style={{height:"35%",top:"19px"}} 
                                    className={stylesSign.ImageInput} />
                            <input
                                value={Email}
                                id="Email" type={"email"}
                   ...
                   <div className={stylesSign.Relativebox}>
                    ...
                    <span className={stylesSign.SigninSpan}>
                        Already Member ?  
                        <a  href="/signIn" className={stylesSign.SigninLink}>
                             Sign in 
                        </a>
                    </span>
